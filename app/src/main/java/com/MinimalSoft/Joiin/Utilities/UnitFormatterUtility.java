...
public class UnitFormatterUtility {
    ...
    public static final SimpleDateFormat dateFormatter = new SimpleDateFormat(DATE_PATTERN, MEXICAN_LOCALE);
    ...
    static public String getCurrentTime() {
        return dateFormatter.format(Calendar.getInstance(MEXICAN_ZONE, MEXICAN_LOCALE).getTime());
    }
